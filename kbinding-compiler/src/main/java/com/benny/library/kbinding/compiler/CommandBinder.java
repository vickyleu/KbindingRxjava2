    ...
    public void generateCode(MethodSpec.Builder builder) {
        ...
        if (hasParameter()) {
            ...
            MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder("execute")
                    ...
                    .addParameter(ParameterizedTypeName.get(ClassName.get(Consumer.class), WildcardTypeName.supertypeOf(ClassName.get(Boolean.class))), "canExecute", Modifier.FINAL);
